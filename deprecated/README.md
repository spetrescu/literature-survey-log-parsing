...
# [deprecated]
This document contains information reagarding the initial workflow created for conducting the exepriments section of [Log Parsing Literature Survey](). However, this is no longer in use. If you want to run the experiments using the latest workflow, go [here](https://github.com/spetrescu/literature-survey-log-parsing#experiments).
## Experiments
