...
with open(RESULTS_FILE) as file:
    for line in file:
        ...
        if "run no" in line and "Dataset" in line and "size" in line:
        ...
        elif "Parsing done." in line and "[Time:" in line and not complete_information_about_row:
            line = line.rstrip("\n")
            print("ZZ")
            ...
            complete_information_about_row = True
        elif "Parsing done." in line and "[Time:" in line and complete_information_about_row:
            line = line.rstrip("\n")
            print()
